import { detailBoardInfoType, sidebarBtnType } from "../types/types";
...
export const DETAIL_BOARD_INFO: detailBoardInfoType = [
  {
    "day's range": "128.46 - 130.89",
  },
  { "52 Week Range": "86.29-145.09" },
  { volume: "91,815,026" },
  { "avg. volume": "88,231,361" },
  { "market cap": "2.172T" },
  { "beta (52 monthly)": "1.21" },
  { "PE ratio (TTM)": "29.25" },
  { "EPS (TTM)": "4.45" },
  { "forward divided": "0.88" },
  { "Ex-Divided data": "2021/05/07" },
];
